...
def TT(space):
    ...
    model = MG(feat.size(1), int(space['outdim']), space['p1'], space['p2'], space['p3'], space['beta'],
               space['beta1'], space['rate'], space['rate1'], space['alpha'],
               space['n'], space['n1']).to(device)
...
# }
# best = fmin(TT, space=space, algo=tpe.suggest, max_evals=1000, trials=trials)
# print(best)
# CiteSeer

#0.734
# TT({'alpha': 0.8, 'beta': 3.0, 'beta1': 1.0, 'lr': 0.01, 'n': 0.46, 'n1': 0.48,
#      'outdim': 2048, 'p1': 0.1, 'p2': 0.4, 'p3': 0.9, 'rate': 0.8, 'rate1': 0.5,
#      'w': 5e-05})

#0.723
# TT({'alpha': 0.8, 'beta': 3.0, 'beta1': 1.0, 'lr': 0.01, 'n': 0.46, 'n1': 0.48,
#      'outdim': 512, 'p1': 0.1, 'p2': 0.4, 'p3': 0.9, 'rate': 0.8, 'rate1': 0.5,
#      'w': 5e-05})

# alpha = [0.1,0.3,0.5,0.7,0.9]
# for i in alpha:
#     TT({'alpha': 0.8, 'beta': 3.0, 'beta1': 1.0, 'lr': 0.01, 'n': 0.46, 'n1': 0.48,
#         'outdim': 2048, 'p1': 0.1, 'p2': 0.4, 'p3': 0.7, 'rate': i, 'rate1': 0.5,
#         'w': 5e-05})
