...
import dgl
from dgl.data import CoraGraphDataset, CiteseerGraphDataset, PubmedGraphDataset, CoauthorPhysicsDataset
...
def process_dataset(name, epsilon=0.01):
    ...
    # if name == 'citeseer' or name == 'Physics':
    ...
    diff_graph = dgl.load_graphs("./diff_g.bin")[0][0]
    print(diff_graph)
    graph = graph.add_self_loop()

    return graph, diff_graph, feat, label, diff_graph.edata["weight"]
