...
# print(best)
# TT({'alpha': 0.6, 'beta': 2.0, 'beta1': 4.0, 'lr': 0.008, 'n': 0.08, 'n1': 0.3,
#     'outdim': 1024, 'p1': 0.7, 'p2': 0.2, 'p3': 0.5, 'rate': 0.9, 'rate1': 0.6, 'w': 0.0001})

alpha = [128,256,512,1024,2048]
for i in alpha:
    TT({'alpha': 0.6, 'beta': 2.0, 'beta1': 4.0, 'lr': 0.008, 'n': 0.08, 'n1': 0.3,
        'outdim': i, 'p1': 0.7, 'p2': 0.2, 'p3': 0.5, 'rate': 0.9, 'rate1': 0.6, 'w': 0.0001})
