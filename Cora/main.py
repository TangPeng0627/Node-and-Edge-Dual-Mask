...
dataname = "cora"
label_type = 0
graph, feat, label, train_mask, val_mask, test_mask = process_dataset(dataname)
...
# trials = Trials()
# space = {
#     "outdim": hp.choice('outdim', [256, 512, 1024]),
...
#0.827
TT({'alpha': 0.8, 'beta': 5.0, 'beta1': 1.0, 'lr': 0.005, 'n': 0.13,
    'n1': 0.15, 'outdim': 1024, 'p1': 0.6, 'p2': 0.6, 'p3': 0.6,
    'rate': 0.7, 'rate1': 0.7, 'w': 0.0, 'acc': 0.827})
