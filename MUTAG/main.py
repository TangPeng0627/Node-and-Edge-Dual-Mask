...
# print(best)lr=0.02,0.005

# TT({'alpha': 0.5, 'beta': 5.0, 'beta1': 3.0, 'dim': 2048, 'lr': 0.0005, 'n1': 5, 'n2': 2,
#     'n3': 2, 'noise': 0.1, 'noise1': 0.1, 'p1': 0.8, 'p2': 0.9, 'p3': 0.9, 'rate': 0.6,
#     'rate1': 0.6, 'w': 1e-05, 'acc': 0.9041})



alpha = [0.1,0.3,0.5,0.7,0.9]
for i in alpha:
    TT({'alpha': i, 'beta': 5.0, 'beta1': 3.0, 'dim': 2048, 'lr': 0.0005, 'n1': 5, 'n2': 2,
        'n3': 2, 'noise': 0.1, 'noise1': 0.1, 'p1': 0.8, 'p2': 0.9, 'p3': 0.9, 'rate': 0.6,
        'rate1': 0.6, 'w': 1e-05, 'acc': 0.9041})